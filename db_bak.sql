...
INSERT INTO `board` (`idx`, `member_idx`, `board_type`, `title`, `content`, `hit`, `recommend`, `regdate`, `moddate`, `ip`, `is_deleted`) VALUES
	...
	(3, 1, 'NOTICE', '[공지] 두번째 테스트 공지사항 입니다.', '안녕안녕하세요', 45, 0, '2025-11-19 15:54:28', NULL, NULL, 0),
	...
	(19, 8, 'FREE', '글 작성 테스트', '<p>123</p><p></p><p><strong>123</strong></p><p></p><p><strong><em>123</em></strong></p><p></p><p><u><strong><em>123</em></strong></u></p><p></p><h1>123</h1><p></p><h2>123</h2><p></p><p></p><ul><li><p>123123</p></li><li><p>123</p></li></ul><ol><li><p>123</p></li><li><p>123</p></li><li><p>123</p></li></ol><p><a target="_blank" rel="noopener noreferrer nofollow" class="editor-link" href="https://www.naver.com/">네이버</a></p><p></p>', 58, 0, '2025-11-20 15:01:17', NULL, '127.0.0.1', 0),
	...
	(27, 9, 'FREE', '쿠키 만료 후 작성 테스트', '<p>테스트</p>', 223, 2, '2025-11-23 21:17:45', NULL, '127.0.0.1', 0),
	...
	(30, 11, 'FREE', 'ㅋㅋ문제점 발견 ㅋㅋㅋㅋ', '<p><img class="editor-image" src="https://192.168.0.190:8070/api/images/MCL/board/2025/11/25/a38cf045-1e57-4473-988c-e36bfae38101.png">ㅈㄱㄴ</p>', 27, 0, '2025-11-25 14:07:50', NULL, '127.0.0.1', 0),
...
INSERT INTO `poke_sample` (`idx`, `member_idx`, `pokemon_idx`, `pokemon_name`, `tera_type`, `item`, `nature`, `ability`, `ivs`, `evs`, `move1`, `move2`, `move3`, `move4`, `description`, `visibility`, `regdate`, `moddate`, `like_count`, `hit`, `is_deleted`) VALUES
	...
	(8, 1, 25, '피카츄', '노말', '자석', '고집', '피뢰침', '31/0/31/31/31/31', 'H252 C252 D4', '10만볼트', '일렉트릭네트', '방전', '방어', '관리자 피카츄', 'PUBLIC', '2025-11-26 16:26:22', '2025-11-27 01:34:38', 1, 57, 0),
	(9, 12, 888, '자시안', '전기', '녹슨검', '명랑', '불요의검', '31/31/31/31/31/31', 'H4 A252 S252', '아이언헤드', '치근거리기', '칼춤', '테라버스트', '최속 AS 자시안', 'PUBLIC', '2025-11-27 01:02:31', '2025-11-27 01:29:49', 0, 8, 0);
