...
-- mcl_project 데이터베이스 구조 내보내기
CREATE DATABASE IF NOT EXISTS `mcl_project` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mcl_project`;
...
CREATE TABLE IF NOT EXISTS `board` (
  ...
  `board_type` enum('NOTICE','FREE') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'FREE',
...
-- 테이블 데이터 mcl_project.board:~20 rows (대략적) 내보내기
INSERT INTO `board` (`idx`, `member_idx`, `board_type`, `title`, `content`, `hit`, `recommend`, `regdate`, `moddate`, `ip`, `is_deleted`) VALUES
	...
	(3, 8, 'NOTICE', '[공지] 두번째 테스트 공지사항 입니다.', '안녕안녕하세요', 37, 0, '2025-11-19 15:54:28', NULL, NULL, 0),
	...
	(13, 8, 'FREE', '안녕하세요 11', '안녕안녕하세요', 1, 0, '2025-11-20 05:54:28', NULL, NULL, 0),
	...
	(19, 8, 'FREE', '글 작성 테스트', '<p>123</p><p></p><p><strong>123</strong></p><p></p><p><strong><em>123</em></strong></p><p></p><p><u><strong><em>123</em></strong></u></p><p></p><h1>123</h1><p></p><h2>123</h2><p></p><p></p><ul><li><p>123123</p></li><li><p>123</p></li></ul><ol><li><p>123</p></li><li><p>123</p></li><li><p>123</p></li></ol><p><a target="_blank" rel="noopener noreferrer nofollow" class="editor-link" href="https://www.naver.com/">네이버</a></p><p></p>', 56, 2, '2025-11-20 15:01:17', NULL, '127.0.0.1', 0),
	(20, 7, 'FREE', '자유 게시판 게시글 작성 테스트', '<p>테스트</p>', 14, 0, '2025-11-20 16:30:55', NULL, '127.0.0.1', 0),
	(21, 7, 'FREE', '이미지 업로드', '<p>이미지 업로드 테스트</p><p><img class="editor-image" src="https://image.utoimage.com/preview/cp872722/2022/12/202212008462_500.jpg" alt="반려견_강아지 사진 이미지 | 유토이미지 | 상세페이지 | 무료이미지 | 사진 | 22250682"></p>', 26, 0, '2025-11-21 13:08:14', NULL, '127.0.0.1', 0),
	(22, 7, 'FREE', '로컬 이미지 업로드 테스트', '<p><img class="editor-image" src="https://192.168.0.190:8070/api/images/MCL/board/2025/11/21/6215aeb1-4d8d-4663-8f4d-bf1c817bf789.webp"><img class="editor-image" src="https://192.168.0.190:8070/api/images/MCL/board/2025/11/21/46222a60-54b1-44f6-8eda-c183e97c3e7a.webp"></p>', 19, 0, '2025-11-21 13:16:52', NULL, '127.0.0.1', 0),
	(23, 7, 'FREE', '새로운 로컬 이미지 첨부 테스트', '<p><img class="editor-image" src="https://192.168.0.190:8070/api/images/MCL/board/2025/11/21/ba236ccf-9ec0-4462-ac7f-f10ccb3d3271.webp">ㅇㅇ</p>', 25, 0, '2025-11-21 13:54:28', '2025-11-21 15:06:58', '127.0.0.1', 0),
...
CREATE TABLE IF NOT EXISTS `board_attachments` (
  ...
  `status` enum('TEMP','ACTIVE') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'TEMP',
  `regdate` datetime NOT NULL,
  PRIMARY KEY (`idx`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- 테이블 데이터 mcl_project.board_attachments:~0 rows (대략적) 내보내기
INSERT INTO `board_attachments` (`idx`, `board_idx`, `dir`, `stored_name`, `original_name`, `status`, `regdate`) VALUES
	...
	(4, NULL, '2025/11/21', '24755dec-5c67-4603-a3df-9cf5d9226dda.jpg', 'cnshop008.jpg', 'TEMP', '2025-11-21 14:17:51'),
...
-- 테이블 데이터 mcl_project.board_comments:~0 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `provider_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- 테이블 데이터 mcl_project.member:~7 rows (대략적) 내보내기
INSERT INTO `member` (`idx`, `userid`, `pwd`, `nickname`, `birth`, `file`, `grade`, `regdate`, `provider`, `provider_id`, `refresh_token`) VALUES
	...
	(7, 'butter', '$2a$10$IbESdILW.0HFsSoCq18gA.jGSu5YNbVxhk0SyGtROeIS8alGds6we', '버터', '2022-02-02', 'MCL/profile/20251121/c972364c-775d-4fcf-aac0-99387889f708.webp', 1, '2025-11-13 16:20:54', 'LOCAL', 'butter', 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJidXR0ZXIiLCJleHAiOjE3NjQzMTQzNDV9.n02zuo0i9MVsw192hp1d2sE0MpSyGaBJhYbCH4LyUFyZroi9UDCKSaWWKVPLlfRGV8gfKEjwXNWvdGiugm814A'),
